...
Лучший способ сообщить о протестированном кондиционере - написать [в разделе багрепортов и заказа фич](https://github.com/GrKoR/esphome_aux_ac_component/issues). В телеграм тоже можно, но есть шанс, что в ворохе сообщений ваше потеряется.
...
Для питания ESP8266 можно использовать любой подходящий DC-DC преобрразователь. Я использовал такой:
